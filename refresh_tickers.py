#!/usr/bin/env python3
"""Ad-hoc script to refresh us_tickers / swe_tickers / uk_tickers metadata (FR-12, RFC-010)."""
...
def refresh_tickers(
    ...
    *,
    ...
    """Resolve and upsert watchlist metadata into us_tickers / swe_tickers / uk_tickers."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Refresh us_tickers / swe_tickers / uk_tickers metadata "
            "(company, sector, industry, listing market, exchange_name)"
        ),
    )
    parser.add_argument(
        "tickers_file",
    ...
    parser.add_argument(
        "--from-db",
        action="store_true",
        help="Refresh all symbols already in us_tickers / swe_tickers / uk_tickers",
    )
    parser.add_argument(
        "--symbols",
        metavar="SYM1,SYM2",
