...
from seed_tickers import resolve_name, seed_tickers_from_file
...
def test_seed_tickers_from_file_resolves_and_upserts(tmp_path) -> None:
    ...
    with patch("seed_tickers.resolve_name", side_effect=["Alpha AB", "Beta AB"]):
    ...
    mock_upsert.assert_called_once_with(
        "postgresql://example",
        [("AAA.ST", "Alpha AB"), ("BBB.ST", "Beta AB")],
    )
